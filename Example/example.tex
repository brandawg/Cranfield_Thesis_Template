...
\begin{listofpublications}
  \pubhead{Conferences}
  \pub{Authors, \textbf{"Title"}, \textit{Conference Proceedings}, Vol.~ii, No.~ii, pp.~ii-ii, Year}
  
  \pubhead{Journals}
  \pub{Authors, \textbf{"Title"}, \textit{Journal} Vol.~ii, No~ii, pp.~ii-ii, Year}

  \pubhead{To Be Published}
  \pub{Authors, \textbf{"Title"}, 2019}
...
% \printbibliography[heading=bibintoc,title=\uppercase{references}]
